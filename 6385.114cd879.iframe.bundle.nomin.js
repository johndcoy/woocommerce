"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[6385],{
...
class SearchFilter extends react.Component {
  ...
  loadLabels(filterValue, query) {
    this.props.config.input.getLabels(filterValue, query).then(selected => {
