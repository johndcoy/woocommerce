"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[3957],{
...
const ProductImage = ({
  ...
  const productImage = (0,lodash.get)(product, ['images', 0]) || (0,lodash.get)(product, ['image']);
  const src = productImage && productImage.src || false;
  const altText = alt || productImage && productImage.alt || '';
  const classes = (0,clsx/* default */.A)('woocommerce-product-image', className, {
    'is-placeholder': !src
  });
...
function getTaxCode(tax) {
  return [tax.country, tax.state, tax.name || (0,build_module.__)('TAX', 'woocommerce'), tax.priority].filter(Boolean).map(item => item?.toString().toUpperCase().trim()).join('-');
}
// EXTERNAL MODULE: ../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");
...
const completer = {
  ...
  options(search) {
    ...
    return (0,api_fetch_build_module["default"])({
  ...
  getFreeTextOptions(query) {
    const label = /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
  ...
  getOptionLabel(attribute, query) {
    ...
    return /*#__PURE__*/(0,jsx_runtime.jsxs)("span", {
      ...
      children: [match?.suggestionBeforeMatch, /*#__PURE__*/(0,jsx_runtime.jsx)("strong", {
        className: "components-form-token-field__suggestion-match",
...
try {
    // @ts-ignore
    getOptionIdentifier.displayName = "getOptionIdentifier";
    // @ts-ignore
    getOptionIdentifier.__docgenInfo = { "description": "", "displayName": "getOptionIdentifier", "props": {} };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/attributes.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/attributes.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    getOptionCompletion.displayName = "getOptionCompletion";
    // @ts-ignore
    getOptionCompletion.__docgenInfo = { "description": "", "displayName": "getOptionCompletion", "props": {} };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/attributes.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/attributes.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    getOptionKeywords.displayName = "getOptionKeywords";
    // @ts-ignore
    getOptionKeywords.__docgenInfo = { "description": "", "displayName": "getOptionKeywords", "props": {} };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/attributes.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/attributes.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/categories.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/categories.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/categories.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/categories.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/categories.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/categories.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
const isCountries = value => {
  return Array.isArray(value) && value.length > 0 && typeof value[0] === 'object' && typeof value[0].code === 'string' && typeof value[0].name === 'string';
};
const countries_completer = {
  name: 'countries',
  ...
  getOptionLabel(country, query) {
    const name = (0,html_entities_build_module/* decodeEntities */.S)(country.name);
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/countries.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/countries.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/countries.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/countries.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/countries.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/countries.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/coupons.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/coupons.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/coupons.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/coupons.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/coupons.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/coupons.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/customers.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/customers.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/customers.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/customers.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/customers.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/customers.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/download-ips.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/download-ips.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/download-ips.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/download-ips.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/download-ips.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/download-ips.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/emails.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/emails.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/emails.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/emails.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/emails.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/emails.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/orders.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/orders.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/orders.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/orders.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/orders.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/orders.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/product.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/product.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/product.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/product.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/product.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/product.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/taxes.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/taxes.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/taxes.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/taxes.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/taxes.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/taxes.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/usernames.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/usernames.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/usernames.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/usernames.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/usernames.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/usernames.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
const variable_product_completer = {
  ...product,
  name: 'products',
  options(search) {
    const query = search ? {
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/variable-product.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/variable-product.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/variable-product.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/variable-product.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/variable-product.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/variable-product.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
...
const variations_completer = {
  ...
  options(search) {
    ...
    const product = (0,src/* getQuery */.$Z)().products;
    ...
    if (product) {
      ...
      return (0,api_fetch_build_module["default"])({
        path: (0,add_query_args/* addQueryArgs */.F)(`/wc-analytics/products/${product}/variations`, query)
      });
    }
...
try {
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/variations.tsx#getOptionIdentifier"] = { docgenInfo: getOptionIdentifier.__docgenInfo, name: "getOptionIdentifier", path: "../../packages/js/components/src/search/autocompleters/variations.tsx#getOptionIdentifier" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/variations.tsx#getOptionCompletion"] = { docgenInfo: getOptionCompletion.__docgenInfo, name: "getOptionCompletion", path: "../../packages/js/components/src/search/autocompleters/variations.tsx#getOptionCompletion" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    ...
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/components/src/search/autocompleters/variations.tsx#getOptionKeywords"] = { docgenInfo: getOptionKeywords.__docgenInfo, name: "getOptionKeywords", path: "../../packages/js/components/src/search/autocompleters/variations.tsx#getOptionKeywords" };
}
catch (__react_docgen_typescript_loader_error) { }
;// ../../packages/js/components/src/search/search.tsx
/**
