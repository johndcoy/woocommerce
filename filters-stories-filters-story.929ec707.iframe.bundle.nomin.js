(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[2406,5190,6204,7782],{
...
function getRangeLabel(after, before) {
  ...
  if (isSameDay) {
    ...
    const dayRangeFormat = replaceDayToken(fullDateFormat, dayToken => `${after.format(dayToken)} - ${before.format(dayToken)}`);
